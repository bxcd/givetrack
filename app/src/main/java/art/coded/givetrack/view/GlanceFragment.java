...
public class GlanceFragment extends Fragment implements
    ...
    private static final String SCROLL_STATE = "art.coded.givetrack.ui.state.GLANCE_SCROLL";
    private static final String USER_STATE = "art.coded.givetrack.ui.state.GLANCE_USER";
    private static final String RECORDS_STATE = "art.coded.givetrack.ui.state.GLANCE_RECORDS";
    private static final String SINCE_STATE = "art.coded.givetrack.ui.state.GLANCE_SINCE";
    private static final String THEME_STATE = "art.coded.givetrack.ui.state.GLANCE_THEME";
...
//            savedInstanceState.clear();
    ...
    void shareText() {
        ...
        String textMessage =
                String.format("%s, I have donated a total of %s to charity! #%s App",
                        timeframe, amount, getString(R.string.app_name));
