...
public class SpawnActivity extends AppCompatActivity implements
    ...
    public static final String ACTION_INDEX_INTENT = "art.coded.givetrack.ui.action.INDEX_INTENT";
    private static final String STATE_PANE = "art.coded.givetrack.ui.state.SPAWN_PANE";
    private static final String STATE_SHOWN = "art.coded.givetrack.ui.state.SPAWN_SHOWN";
    private static final String STATE_ADDED = "art.coded.givetrack.ui.state.ADDED_TARGET";
    private static final String STATE_REMOVED = "art.coded.givetrack.ui.state.REMOVED_TARGET";
    private static final String STATE_POSITION = "art.coded.givetrack.ui.state.PANE_POSITION";
