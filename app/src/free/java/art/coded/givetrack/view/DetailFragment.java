...
public class DetailFragment extends Fragment {
    ...
    static final String ACTION_CUSTOM_TABS = "art.coded.givetrack.ui.action.CUSTOM_TABS";
    static final String ARG_ITEM_COMPANY = "art.coded.givetrack.ui.arg.ITEM_NAME";
    private static final String SCROLL_STATE = "art.coded.givetrack.ui.state.DETAIL_SCROLL";
    private static final String INITIAL_STATE = "art.coded.givetrack.ui.state.DETAIL_INITIAL";
    private static final String CURRENT_STATE = "art.coded.givetrack.ui.state.DETAIL_CURRENT";
    private static final String COMPANY_STATE = "art.coded.givetrack.ui.state.DETAIL_COMPANY";
